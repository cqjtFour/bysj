...
public class ApplyService {
     ...
     * 通过岗位编号获取所有应聘该岗位的学生
     */
    public List<Apply> getStudentsByGw(int yrdwxxbbh,int zpgwbh, String startTime , String endTime,int ckzt){

        return applyMapper.getStudentsByGw(yrdwxxbbh,zpgwbh,startTime,endTime,ckzt);
    }
}
