...
public class SchoolJobService {
     ...
     * 插入一条新校园招聘预约表
     */
    public Integer insertSchoolJob(SchoolJob schoolJob){ return  schoolJobMapper.insert(schoolJob);}

    /**
     * 获取当前校园招聘预约表的编号
     */
    public Integer  getSchoolJobId(int  yrdwxxbbh,String yynr){ return  schoolJobMapper.getSchoolJobId(yrdwxxbbh,yynr);}
}
