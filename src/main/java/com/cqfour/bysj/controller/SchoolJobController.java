...
public class SchoolJobController {
	...
	public String resApplication(@RequestParam(value = "page", defaultValue = "1")Integer page, @RequestParam(value = "yyzt",defaultValue = "-1") Short yyzt, HttpServletRequest request){
