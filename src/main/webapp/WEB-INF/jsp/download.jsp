    ...
    <div id="contentsec">
        <div class="inner">
            <div class="fullwidth box left">
                <h3 class="widget-head-border colr">下载中心</h3>
                <div class="boxshadow">
                    <div class="boxshadow-left">
                        <div class="list-show">
                            <div class="list">
                                <div>
                                    <p>
                                        <a href="/News/2001/10006/7012.html" title="假期改派、就业协议盖章办理时间" class="title">假期改派、就业协议盖章办理时间</a>
                                    </p>
                                    <p>
                    ...
                    <div class="boxshadow-right">
                        <div class="boxshadow-right-up">
                            <div class="boxshadow-right-title">
                                <span class="title left">热门下载中心</span>
                            </div>
                        ...
                        <div class="boxshadow-right-down">
                            <div class="boxshadow-right-title">
                                <div class="left">最新下载中心</div>
                            </div>
                            <div class="boxshadow-right-show">
                                <ul class="multi" style="height: 256px;">
                                    <li><a href="" title="">假期改派、就业协议盖章办理时间</a></li>
