    ...
    <div id="bread-crumb">
        <div class="inner">
            <ul>
                ...
                <li><span class="glyphicon glyphicon-leaf" style="margin-right:5px ;"></span><a href="#">就业政策</a></li>
            </ul>
            <div class="clear"></div>
        </div>
    </div>
    ...
    <div id="contentsec">
        <div class="inner">
            <div class="fullwidth box left">
                <h3 class="widget-head-border colr" style="font-family: 'Microsoft yahei', Arial, Helvetica, sans-serif">就业政策</h3>
                <div class="boxshadow">
                    ...
                    <div class="boxshadow-right">
                        <div class="boxshadow-right-up">
                            <div class="boxshadow-right-title">
                                <span class="title left" >热门就业政策</span>
                            </div>
