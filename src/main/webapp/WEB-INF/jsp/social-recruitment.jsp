    ...
    <div id="bread-crumb">
        <div class="inner">
            <ul>
                ...
                <li><span class="glyphicon glyphicon-grain" style="margin-right: 5px;"></span><a href="#">社会招聘</a></li>
            </ul>
            <div class="clear"></div>
        </div>
    </div>
                ...
                <div class="boxshadow">
                    <div class="boxshadow-left">
                        ...
                        <div class="form-group" >
                            <select onclick="showOption(this)" style="width: 100px;height: 30px ;margin-left: 20px;border-radius:5px;">
                                <option value="1">所属行业</option>
                                <option value="1">法师</option>
                                <option value="2">战士</option>
                                <option value="3">刺客</option>
                            </select>
                            <select id="YX" style="width: 100px;height: 30px;margin-left: 5px;border-radius:5px;">
                                <option value="">职位类别</option>
                            </select>
                            <input type="text" style="border-radius:5px;width: 200px;height: 30px">
                            <button type="button" class="btn btn-info" style="height: 30px;margin-bottom: 4px">搜索职位或公司</button>
                        </div>
                        <script type="text/javascript" >
                            var yx = [["貂蝉","小乔","大桥"],["吕布","张飞"],["李白","荆轲"]];
                            function showOption(obj){
                                var index = obj.selectedIndex;
                                var yingxiong = yx[index-1];

                                var yxoption = document.getElementById("YX");
                                for (var i=1;i< yxoption.length;i++){
                                    yxoption[i].remove();
                                }
                                for (var i=0;i< yingxiong.length;i++) {
                                    var op = new Option(yingxiong[i]);
                                    yxoption.appendChild(op);
                                }
                            }
                        </script>
