...
<head>
    ...
    <script type="text/javascript" >
        $(document).ready(function () {
            ...
            $("#ly").click(function () {
                var fsyhzh=$("#fsyhzh").val();
                var jsyhzh=$("#jsyhzh").val();
                $.ajax({
                    url:"/studentEmployerMessage",
                    type:"post",
                    dataType:"json",
                    data:{fsyhzh:fsyhzh,jsyhzh:jsyhzh},
                    success:function (result) {
                        console.log(result);
                      ...
                      工作地点：
                            ...
                            <li>
                                <button type="button"  class="btn btn-info " data-toggle="modal" data-target=".bs-example-modal-sm">
                                    <span class="glyphicon glyphicon-ok">投递简历</span>
                                </button>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="boxshadow-right">
                    <div class="boxshadow-right-up">
                        <div class="boxshadow-right-title">
                            ...
                            <a id="ly"  style="margin-right:20px;cursor: pointer" class="right">
                                <span class="glyphicon glyphicon-comment" style="font-size: 25px"></span>
                            </a>

                            <input type="hidden" id="jsyhzh" value="${employers.getDlzh()}">
                            <input type="hidden" id="fsyhzh" value="${student.xh}">
                        </div>
